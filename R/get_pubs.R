...
publications <- function(
  ...
  doi_path = paste0(system.file("", package = "conig"), "/", id, "_doi.rds")
  author_path = paste0(
    system.file("", package = "conig"),
    "/",
    id,
    "_authors.rds"
  )
  ...
  extra_info = function(row) {
    cid = pubs[row, "cid"]
    cite_link = glue::glue(
      "https://scholar.google.com/scholar?oi=bibs&hl=en&cites={cid}"
    )
