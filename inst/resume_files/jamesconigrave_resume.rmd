...
section_heading <- function(title, icon) {
...
if (experience > 0) {
  ...
  exp_header <- r"(Academic appointments {data-icon=laptop}
--------------------------------------------------------------------------------)"
...
professional_content <- r"(Earlier professional roles {data-icon=suitcase}
--------------------------------------------------------------------------------
...
if (grants) {
  cat(
    section_heading("Selected funding", "file-invoice-dollar")
  )
...
if (commentaries) {
  cat(
    section_heading("Research translation", "quote-left")
  )
...
if (preprints) {
  cat(
    section_heading("Preprints", "file")
  )
...
if (peer_review) {
  ...
  cat(
    section_heading("Recent peer review", "user-friends")
  )
...
if (conferences) {
  cat(
    section_heading("Conference contributions", "globe-asia")
  )

  conf <- data.table::fread(system.file("db/conference.csv", package = "conig")) |>
    dplyr::arrange(desc(year))
