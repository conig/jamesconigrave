...
- Years post conferral: `r round(conig::years_since_conferral())`
...
This HTML document was created using [pagedown](https://github.com/rstudio/pagedown) in R. Publications are generated from Google Scholar using the [scholar](https://github.com/jkeirstead/scholar) library. [Check out the code on GitHub](https://github.com/conig/jamesconigrave/).
